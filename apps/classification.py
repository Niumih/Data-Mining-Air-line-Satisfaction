...
layout = html.Div([
    dbc.Container([
        ...
        dbc.Row([
                dbc.Col(dbc.Card([html.H4(children="Satisfaction count of each class by Age",className="text-center text-nav")
        ...
        dbc.Row([
                dbc.Col(dbc.Card([html.H4(children="Satisfied/Dissatisfied Count of each class",className="text-center  text-nav")
        ...
        dbc.Row([
                dbc.Col(dbc.Card([html.H4(children="Satisfied/Dissatisfied Count of each class by their passenger type",className="text-center  text-nav")
        ...
        dbc.Row([
                dbc.Col(dbc.Card([html.H4(children="Satisfied/Dissatisfied Count of each class by their gender",className="text-center  text-nav")
        ...
        dbc.Row([
                dbc.Col(dbc.Card([html.H4(children="Satisfied/Dissatisfied Count of each class by their type of travel",className="text-center text-nav")

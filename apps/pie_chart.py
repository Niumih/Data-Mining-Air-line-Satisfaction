...
dff6 = Airline.groupby(['Seat comfort'], as_index=False)[
    ['Online boarding']].count()
dff7 = Airline.groupby(['Inflight wifi service'], as_index=False)[
    ['Online boarding']].count()
dff8 = Airline.groupby(['Inflight entertainment'], as_index=False)[
    ['Online boarding']].count()
dff9 = Airline.groupby(['Online support'], as_index=False)[
    ['Online boarding']].count()
dff10 = Airline.groupby(['Ease of Online booking'], as_index=False)[
    ['Online boarding']].count()
dff11 = Airline.groupby(['Online boarding'], as_index=False)[
    ['Online boarding']].count()
dff12 = Airline.groupby(['Leg room service'], as_index=False)[
    ['Online boarding']].count()
dff13 = Airline.groupby(['Cleanliness'], as_index=False)[
    ['Online boarding']].count()
dff14 = Airline.groupby(['Food and drink'], as_index=False)[
    ['Online boarding']].count()
...
layout = html.Div([
    dbc.Container([
        ...
        dbc.Row([
            dbc.Col(
                html.H1(children='Airline Passenger Satisfaction Prediction'), className="mb-2")
        ], className="main-topic"),
        # main sub topic
        dbc.Row([
            dbc.Col(html.H6(
                children='Analysis & Passenger Satisfaction Prediction on US Airline'), className="mb-2")
        ], className="main-topic"),

        dbc.Row([
                dbc.Col(dbc.Card([html.H4(children="Ratings (1 - 5)", className="text-center text-nav")

                                  ], body=True, className="card-col-main-row"), className="mt-2 mb-1",
                        )
                ], className="main-row"
                ),
        ...
        dbc.Row([
                ...
                dbc.Col(
                    dcc.Graph(id='my-graph-sat-Inflight-entertainment'), width=4),
        ...
        dbc.Row([
                ...
                dbc.Col(
                    dcc.Graph(id='my-graph-sat-Ease-of-Online-booking'), width=4),
